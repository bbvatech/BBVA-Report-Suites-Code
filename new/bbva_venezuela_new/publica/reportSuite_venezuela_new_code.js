...
if (_satellite && _satellite.settings.isStaging == true)
    r_suite = 'bbvav.global.2017.dev'; //dev suite 
else
    r_suite='bbvav.global.2017'; //production suite 
...
s.visitor = Visitor.getInstance("3CE98674578970357F000101@AdobeOrg",{
    trackingServer: "bbvave.d3.sc.omtrdc.net"
});
...
s.linkTrackVars="eVar24,prop22,eVar25,prop18,prop19,prop20";
s.linkTrackEvents="";
s.events = "";
